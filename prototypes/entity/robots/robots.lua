...
bulkdrone.icon = "__Sky-Atlas-Metallurgy__/graphics/entity/misc/construction-robo-ico.png"
...
bulkdrone.in_motion.filename =  "__Sky-Atlas-Metallurgy__/graphics/entity/misc/construction-robot.png"
local shadows = {
  filename = "__Sky-Atlas-Metallurgy__/graphics/entity/misc/construction-robot-shadow.png",
  priority = "high",
  line_length = 16,
  width = 64,
  height = 64,
