data:extend({
	...
	},
	{
		...
		enabled = true,
		energy_required = 25,
		ingredients = { { "engine-unit", 2 }, { "havar-plate", 10 }, { "processing-unit", 5} },
		results = {
			{ "aquatic-miner", 1 },
		},
		icon_size = 64,
	...
	},
	{
		...
		enabled = true,
		ingredients = {
			{ type = "fluid", name = "aquatic-slurry", amount = 10 },
		},
		results = {
			{ type = "fluid", name = "oxygen", amount = 50 },
			{ type = "fluid", name = "aquamethane", amount = 30 },
			{ type = "fluid", name = "hydrochlorine", amount = 30 },
		}
	},
	{
		type = "recipe",
		name = "aquatic-hc-cracking",
		category = "oil-processing",
		subgroup = "sam-fluid-recipes",
		hide_from_player_crafting = true,
		order = "ab",
		...
		enabled = true,
		ingredients = {
			{ type = "fluid", name = "hydrochlorine", amount = 10 },
		},
		results = {
	...
	},
	{
		...
		enabled = true,
		ingredients = {
			{ type = "fluid", name = "aquatic-slurry", amount = 20 },
		},
		results = {
			{name = "aluminum-ore", amount = "4" , probability = 0.2},
			{name = "magnetite-ore", amount = "4" , probability = 0.2},
			{name = "lead-ore", amount = "4" , probability = 0.2},
			{name = "nickel-ore", amount = "4" , probability = 0.2},
			{name = "monazite-ore", amount = "4" , probability = 0.2},
			{name = "chromite-ore", amount = "4" , probability = 0.2},
			{ type = "fluid", name = "water", amount = 30 },
		},
	},
	{
		type = "recipe",
		name = "methanol-creation",
		category = "advanced-crafting",
		hide_from_player_crafting = true,
		order = "ab",
		icon = "__Sky-Atlas-Metallurgy-Rebirth__/graphics/icons/aquatic-ore.png",
	...
	},
	{
		...
		results = {
			{name = "plastic-polymers", amount = 5 },
		},
	},
	{
		type = "recipe",
		...
		enabled = true,
		ingredients = {
			{name = "plastic-polymers", amount = 2 },
			{type = "fluid", name = "methanol", amount = 10 },
		},
		results = {
	...
	},
	{
		...
		category = "chemistry",
		main_product = "refined-uranium-ore",
		hide_from_player_crafting = true,
		order = "ad",
	...
	},
	{
		...
		enabled = true,
		ingredients = {
			{ "refined-uranium-ore", 4 },
		},
		results = {
			{ type = "fluid", name = "uranium-slurry", amount = 50 },
		},
	},
	{
		type = "recipe",
		...
		enabled = true,
		ingredients = {
			{ type = "fluid", name = "uranium-slurry", amount = 40 },
		},
		results = {
			{
				name = "uranium-shard",
	...
	{
		type = "recipe",
		name = "pure-uranium-shard",
		category = "chemistry",
		main_product = "purified-uranium-shard",
		hide_from_player_crafting = true,
		order = "ad",
		icon = "__base__/graphics/icons/uranium-ore.png",
		icon_size = 64,
		...
		ingredients = {
			...
			{ type = "fluid", name = "muriatic-acid", amount = 25 },
		},
		results = {
			{
	...
	{
		type = "recipe",
		name = "pure-uranium-ore-chemical",
		category = "chemistry",
		main_product = "imperfect-uranium-ore",
		hide_from_player_crafting = true,
		order = "ad",
		icon = "__base__/graphics/icons/uranium-ore.png",
		icon_size = 64,
		...
		enabled = true,
		ingredients = {
			{ "purified-uranium-shard", 2 },
			{ type = "fluid", name = "buren-acid", amount = 25 },
			{ type = "fluid", name = "vixal-acid", amount = 25 },
		},
		results = {
			{
	...
	},
	{
		...
		category = "chemistry",
		main_product = "refined-uranium-powder",
		hide_from_player_crafting = true,
		order = "ac",
		icon = "__base__/graphics/icons/uranium-ore.png",
		icon_size = 64,
	...
	},
	{
		...
		category = "chemistry",
		main_product = "pure-uranium-powder",
		hide_from_player_crafting = true,
		order = "ad",
		icon = "__base__/graphics/icons/uranium-ore.png",
		icon_size = 64,
	...
	},
	{
		...
		enabled = true,
		ingredients = {
			{ "pure-uranium-powder", 1 },
			{ type = "fluid", name = "steam", amount = 100 },
			{ type = "fluid", name = "acid-cleaning-solution", amount = 10 },
		},
		result = "pure-uranium-ore",
		result_count = 3,
	},
	...
	{
		type = "recipe",
		name = "refined-uranium-sorting",
		energy_required = 300,
		enabled = true,
		category = "centrifuging",
		ingredients = { { "refined-uranium-ore", 10 } },
		icon = "__base__/graphics/icons/nuclear-fuel-reprocessing.png",
		icon_size = 64,
		icon_mipmaps = 4,
		subgroup = "metallurgy-processes",
		order = "r[uranium-processing]-b[nuclear-fuel-reprocessing]",
		main_product = "",
		results = { { "uranium-235", 3}, { "uranium-238", 97}},
		allow_decomposition = false,
	},
	{
		type = "recipe",
		name = "imperfect-uranium-sorting",
		energy_required = 300,
		enabled = true,
		category = "centrifuging",
		ingredients = { { "imperfect-uranium-ore", 10 } },
		icon = "__base__/graphics/icons/nuclear-fuel-reprocessing.png",
		icon_size = 64,
		icon_mipmaps = 4,
		subgroup = "metallurgy-processes",
		order = "r[uranium-processing]-b[nuclear-fuel-reprocessing]",
		main_product = "",
		results = { { "uranium-235", 7}, { "uranium-238", 93}},
		allow_decomposition = false,
	},
	{
		type = "recipe",
		name = "pure-uranium-sorting",
		energy_required = 300,
		enabled = true,
		category = "centrifuging",
		ingredients = { { "pure-uranium-ore", 10 } },
		icon = "__base__/graphics/icons/nuclear-fuel-reprocessing.png",
		icon_size = 64,
		icon_mipmaps = 4,
		subgroup = "metallurgy-processes",
		order = "r[uranium-processing]-b[nuclear-fuel-reprocessing]",
		main_product = "",
		results = { { "uranium-235", 12}, { "uranium-238", 84}},
		allow_decomposition = false,
	},
