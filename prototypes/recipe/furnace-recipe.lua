data:extend({
	...
	},
	{
		...
		category = "alloy-smelting",
		subgroup = "refined-metallurgy",
		ingredients = { { "iron-plate", 5 }, { "nickel-plate", 3 }, { "cobalt-plate", 2 }, {"scarce-metal-ores", 4} },
		results = { { "kovar-plate", 1 } },
		energy_required = 8,
		enabled = true,
	},
	{
	...
	},
	{
		...
		category = "alloy-smelting",
		subgroup = "refined-metallurgy",
		ingredients = { { "scarce-metal-ores", 2 }, { "aluminum-plate", 1 }, { "thorium-ore", 5 } },
	...
	},
	{
		...
		category = "alloy-smelting",
		subgroup = "refined-metallurgy",
		ingredients = { { "carbonatite-ore", 2 }, { "rare-earth-ore", 4 }, { "thorium-ore", 10 } },
